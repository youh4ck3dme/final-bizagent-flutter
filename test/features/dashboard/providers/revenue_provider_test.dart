...
void main() {
  ...
  test(
    'RevenueMetrics should calculate correctly for empty invoices',
    () async {
      container = ProviderContainer(
  ...
  test(
    'RevenueMetrics should calculate revenue for different periods',
    () async {
  ...
  test(
    'RevenueMetrics should calculate unpaid amount and overdue count',
    () async {
      final now = DateTime.now();
