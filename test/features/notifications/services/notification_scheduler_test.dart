...
void main() {
      ...
      overrides: [
        ...
        invoicesProvider.overrideWith((ref) => Stream.value([
          ...
          InvoiceModel(
            ...
            number: '2024002',
            dateIssued: DateTime.now(),
            dateDue: DateTime.now().subtract(const Duration(days: 1)), // Already due
            status: InvoiceStatus.sent,
            items: [],
            totalAmount: 200,
  ...
  test('NotificationScheduler should schedule alerts for sent invoices and tax deadlines', () async {
