...
void main() {
  ...
  group('CategorizationService - Komunikácia', () {
    test('rozpozná Orange ako telefón', () {
      final (category, confidence) = service.suggestCategory('Orange Slovensko');
  ...
  group('CategorizationService - Poistenie', () {
    test('rozpozná poisťovňu', () {
      final (category, _) = service.suggestCategory('Allianz Slovenská poisťovňa');
      expect(category, isIn([
    ...
    test('rozpozná poistenie auta', () {
      final (category, _) = service.suggestCategory('Kooperativa Auto poistenie');
      expect(category, ExpenseCategory.carInsurance);
    });

    test('rozpozná zdravotné poistenie', () {
      final (category, _) = service.suggestCategory('Union zdravotná poisťovňa');
  ...
  group('CategorizationService - Služby', () {
    ...
    test('rozpozná právne služby', () {
      final (category, _) = service.suggestCategory('Advokátska kancelária Novák');
  ...
  group('CategorizationService - Prevádzkové náklady', () {
    test('rozpozná nájom', () {
      final (category, _) = service.suggestCategory('Prenájom priestorov Bratislava');
    ...
    test('rozpozná vodu', () {
      final (category, _) = service.suggestCategory('BVS Vodárenská spoločnosť');
  ...
  group('CategorizationService - Ostatné', () {
    ...
    test('neznámy dodávateľ vráti Other s nízkou istotou', () {
      final (category, confidence) = service.suggestCategory('Neznámy dodávateľ XYZ');
