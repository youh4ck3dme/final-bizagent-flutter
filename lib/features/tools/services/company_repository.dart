...
// 3) Flutter “Fixer”: vždy posiela contract header
    ...
    // Use Dio or http to call our new endpoint
    final dio = Dio(BaseOptions(
      baseUrl: 'https://bizagent.sk', // Production base
      headers: {
    ...
    // Handle local dev ports if needed (optional logic here)
    
    try {
      final response = await dio.post('/api/ico-lookup', data: {'ico': ico});
