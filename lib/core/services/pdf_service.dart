...
import 'qr_payment_service.dart';
...
class PdfService {
  ...
  pw.Widget _buildQrPaymentBlock({
    ...
    final qr = QrPaymentService();
    final payload = qr.buildEpcPayload(QrPaymentInput(
      iban: iban,
      beneficiaryName: beneficiaryName,
      amountEur: amountEur,
      paymentReference: variableSymbol,
      remittanceInfo: message,
    ));
